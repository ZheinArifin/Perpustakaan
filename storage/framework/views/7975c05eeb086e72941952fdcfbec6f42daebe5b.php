            ...
            <div class="card">
              ...
              <div class="card-body" style="box-shadow: 3px 8px 16px rgba(0,0,0,0.6)">
                ...
                <?php echo e(csrf_field()); ?>
                        ...
                        <input name='id' hidden value="<?php echo e($kd); ?>" type="text" required class="col-sm-12 form-control" style="text-transform:uppercase" onkeypress="return /[0-9A-Z]/i.test(event.key)">
                        <div class="row pb-2">
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Perpustakaan\resources\views/Page/Anggota/add-anggota.blade.php ENDPATH**/ ?>
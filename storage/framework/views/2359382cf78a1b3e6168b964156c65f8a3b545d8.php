                            ...
                            <div class="row pb-2">
                                <div class="col-md-12 col-lg-12 col-sm-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name='kd_buku' readonly value="<?php echo e($kodeBuku); ?>" type="text" required class="col-sm-12 form-control" minlength="4" style="text-transform:uppercase" onkeypress="return /[0-9A-Z]/i.test(event.key)">
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Perpustakaan\resources\views/Page/Buku//add-buku.blade.php ENDPATH**/ ?>
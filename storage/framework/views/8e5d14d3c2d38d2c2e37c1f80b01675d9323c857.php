        ...
        <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input name="id_anggota" type="hidden" class="form-control" required value="<?php echo e(session()->get('Id')); ?>" readonly>
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Perpustakaan\resources\views/Page/Peminjaman/peminjaman.blade.php ENDPATH**/ ?>